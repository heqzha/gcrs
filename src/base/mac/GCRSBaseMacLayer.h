...
#ifndef GCRSBASEMACLAYER_H_
#define GCRSBASEMACLAYER_H_
#include <assert.h>
#include <omnetpp.h>
#include <queue>
...
class GCRSBaseMacLayer: public BaseMacLayer {
public:
    ...
    public:
        class EDCAQueue {
        public:
            std::queue<GCRSBaseNetPkt*> queue;
        ...
        EDCA(t_channel channelType, int maxQueueLength = 0) :
                numQueues(0), maxQueueSize(maxQueueLength), channelType(
                        channelType) {
        ...
        int queuePacket(t_access_category AC, GCRSBaseNetPkt* cmsg);
        ...
        GCRSBaseNetPkt* initiateTransmit(simtime_t idleSince);
    public:
